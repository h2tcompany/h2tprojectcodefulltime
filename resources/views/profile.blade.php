...
@section('content')
    @if($detailsProfile != null)
        <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-sm-6 col-md-5">
                                        <div class="about-img">
                                            <img style="width: 100%" src="https://www.secret-source.eu/wp-content/uploads/2017/11/Laravel-logo.jpg" class="img-fluid rounded b-shadow-a" alt="">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-7">
                                        <div class="about-info">
                                            <p><span class="title-s"><b>Name:</b> </span>
                                                <span>{{Session::get('acc')->name}}</span></p>
                                            <p><span class="title-s"><b>Profile:</b> </span>
                                                <span>{{$detailsProfile->profile}}</span></p>
                                            <p><span class="title-s"><b>Email:</b> </span>
                                                <span>{{Session::get('acc')->email}}</span>
                                            </p>
            ...
            @if($detailsProfile->has_updated == 0)
                <div class="row">
